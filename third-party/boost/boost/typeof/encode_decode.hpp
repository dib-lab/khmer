...
#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace { namespace pkgboost_typeof {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER pkgboost_typeof

#else

#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace pkgboost { namespace type_of {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER pkgboost::type_of
