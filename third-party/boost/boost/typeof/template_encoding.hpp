...
#define BOOST_TYPEOF_REGISTER_TEMPLATE_IMPL(Name, Params, Size, ID)\
    ...
    {\
        typedef typename pkgboost::type_of::push_back<V, pkgboost::mpl::size_t<ID> >::type V0;\
    ...
    {\
        typedef decode_type_impl<pkgboost::mpl::size_t<ID>, Iter> self_t;\
        typedef pkgboost::mpl::size_t<ID> self_id;\
        typedef Iter iter0;\
