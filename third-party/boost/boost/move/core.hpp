...
#include <boost/move/detail/config_begin.hpp>
   ...
   template <class T>
   class rv
      : public ::pkgboost::move_detail::if_c
         < ::pkgboost::move_detail::is_class_or_union<T>::value
         , T
         , ::pkgboost::move_detail::empty
         >::type
   {
      rv();
      ~rv();
   ...
   template <class T>
   struct is_rv
      : ::pkgboost::move_detail::integral_constant<bool, false>
   {};
   ...
   struct has_move_emulation_enabled
      : ::pkgboost::move_detail::is_convertible< T, ::pkgboost::rv<T>& >
   {};
   ...
   template<class T>
   struct has_move_emulation_enabled< ::pkgboost::rv<T> >
      : ::pkgboost::move_detail::integral_constant<bool, false>
   {};
   ...
   #define BOOST_RV_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      ::pkgboost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_RV_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      ::pkgboost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      const ::pkgboost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_COPY_ASSIGN_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      const ::pkgboost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   #define BOOST_COPYABLE_AND_MOVABLE(TYPE)\
      ...
      {  this->operator=(static_cast<const ::pkgboost::rv<TYPE> &>(const_cast<const TYPE &>(t))); return *this;}\
      public:\
      operator ::pkgboost::rv<TYPE>&() \
      {  return *static_cast< ::pkgboost::rv<TYPE>* >(this);  }\
      operator const ::pkgboost::rv<TYPE>&() const \
