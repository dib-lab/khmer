...
#define BOOST_PRIVATE_GCD_UF( Ut )                  \
    ...
    BOOST_PRIVATE_GCD_UF( pkgboost::ulong_long_type );
...
#ifdef BOOST_HAS_LONG_LONG
    BOOST_PRIVATE_GCD_SF( pkgboost::long_long_type, pkgboost::ulong_long_type );
#elif defined(BOOST_HAS_MS_INT64)
