...
typedef parameter::parameters<pkgboost::parameter::optional<tag::allocator>,
                              pkgboost::parameter::optional<tag::capacity>
                             > queue_signature;
 ...
 *
 *  \b Policies:
 *  - \ref pkgboost::lockfree::fixed_sized, defaults to \c pkgboost::lockfree::fixed_sized<false> \n
 ...
 *
 *  - \ref pkgboost::lockfree::capacity, optional \n
 ...
 *
 *  - \ref pkgboost::lockfree::allocator, defaults to \c pkgboost::lockfree::allocator<std::allocator<void>> \n
...
template <typename T,
          class A0 = pkgboost::parameter::void_,
          class A1 = pkgboost::parameter::void_,
          class A2 = pkgboost::parameter::void_>
#else
template <typename T, ...Options>
#endif
class queue
#ifdef BOOST_NO_CXX11_DELETED_FUNCTIONS
    : pkgboost::noncopyable
#endif
{
private:
#ifndef BOOST_DOXYGEN_INVOKED
    ...
    BOOST_STATIC_ASSERT((pkgboost::has_trivial_destructor<T>::value));
#endif

#ifdef BOOST_HAS_TRIVIAL_ASSIGN
    BOOST_STATIC_ASSERT((pkgboost::has_trivial_assign<T>::value));
#endif
...
public:
    ...
    /** \copydoc pkgboost::lockfree::stack::reserve
     * */
    ...
    /** \copydoc pkgboost::lockfree::stack::reserve_unsafe
     * */
...
public:
    ...
    /// \copydoc pkgboost::lockfree::queue::consume_one(Functor & rhs)
    template <typename Functor>
    ...
    /// \copydoc pkgboost::lockfree::queue::consume_all(Functor & rhs)
    template <typename Functor>
