...
struct fixed_sized:
    pkgboost::parameter::template_keyword<tag::fixed_sized, pkgboost::mpl::bool_<IsFixedSized> >
{};
...
struct capacity:
    pkgboost::parameter::template_keyword<tag::capacity, pkgboost::mpl::size_t<Size> >
{};
...
struct allocator:
    pkgboost::parameter::template_keyword<tag::allocator, Alloc>
{};
