...
#if defined(BOOST_LOCKFREE_NO_HDR_ATOMIC)
using pkgboost::atomic;
using pkgboost::memory_order_acquire;
using pkgboost::memory_order_consume;
using pkgboost::memory_order_relaxed;
using pkgboost::memory_order_release;
#else
using std::atomic;
