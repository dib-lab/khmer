...
namespace pkgboost { namespace mpl {
...
#  define BOOST_PARAMETER_NAME_OBJECT(tag, name)                    \
    static ::pkgboost::parameter::keyword<tag> const& name             \
       = ::pkgboost::parameter::keyword<tag>::instance;
# else
#  define BOOST_PARAMETER_NAME_OBJECT(tag, name)                    \
    namespace                                                       \
    {                                                               \
       ::pkgboost::parameter::keyword<tag> const& name                 \
       = ::pkgboost::parameter::keyword<tag>::instance;                \
    }
# endif
      ...
      {                                                             \
          ...
          {                                                         \
              return BOOST_PP_STRINGIZE(tag);                       \
                                                                    ...
                                                                    \
          typedef pkgboost::parameter::value_type<                     \
              pkgboost::mpl::_2, tag, pkgboost::parameter::void_          \
          > _;                                                      \
                                                                    \
          typedef pkgboost::parameter::value_type<                     \
              pkgboost::mpl::_2, tag, pkgboost::parameter::void_          \
...
# define BOOST_PARAMETER_TEMPLATE_KEYWORD(name)                     \
    ...
    template <class T>                                              \
    struct name                                                     \
      : pkgboost::parameter::template_keyword<tag::name, T>            \
    {};                                                             \
/**/
