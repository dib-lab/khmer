...
namespace pkgboost { namespace parameter { namespace aux {
...
template <
  ...
  , BOOST_PP_ENUM_BINARY_PARAMS(
        BOOST_PARAMETER_MAX_ARITY, class A, = pkgboost::parameter::void_ BOOST_PP_INTERCEPT
    )
>
struct match
...
template <class T>
msvc_store_type<pkgboost::is_convertible<mpl::_,T>,void*(*)(void*(T))>
msvc_store_predicate_type(void*(*)(void*(T)));
...
struct funptr_predicate
{
    ...
    struct apply
    {
        BOOST_STATIC_CONSTANT(bool, result = 
            sizeof(check_predicate(pkgboost::type<T>(), (Args*)0, &p)) == 1
        );
...
}}} // namespace pkgboost::parameter::aux
...
#  define BOOST_PARAMETER_FUNCTION_FWD_MATCH_Z(z, name, parameters, n) \
    , typename pkgboost::parameter::aux::match< \
...
# define BOOST_PARAMETER_FUNCTION_FWD_FUNCTION00(z, n, r, data, elem) \
    ...
    BOOST_PP_EXPR_IF(n, typename) \
        ...
        BOOST_PP_EXPR_IF(n, typename) \
        pkgboost::parameter::aux::argument_pack< \
...
// Builds pkgboost::parameter::parameters<> specialization
...
#  define BOOST_PARAMETER_FUNCTION_PARAMETERS_QUALIFIER_deduced_optional(tag) \
    optional<pkgboost::parameter::deduced<tag>

#  define BOOST_PARAMETER_FUNCTION_PARAMETERS_QUALIFIER_deduced_required(tag) \
    required<pkgboost::parameter::deduced<tag>
...
#  define BOOST_PARAMETER_FUNCTION_PARAMETERS_M(r,tag_namespace,i,elem) \
    BOOST_PP_COMMA_IF(i) \
    pkgboost::parameter::BOOST_PP_CAT( \
      ...
      , typename pkgboost::parameter::aux::unwrap_predicate< \
...
#  define BOOST_PARAMETER_FUNCTION_PARAMETERS_M(r,tag_namespace,i,elem) \
    ...
    pkgboost::parameter::BOOST_PP_CAT( \
      ...
      , pkgboost::parameter::aux::funptr_predicate< \
...
#  define BOOST_PARAMETER_FUNCTION_PARAMETERS_M(r,tag_namespace,i,elem) \
    ...
    pkgboost::parameter::BOOST_PP_CAT( \
      ...
      , pkgboost::mpl::always<pkgboost::mpl::true_> \
    >
# endif
...
# define BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_DEFAULT(arg, tag_namespace) \
    pkgboost::parameter::keyword< \
        tag_namespace::BOOST_PARAMETER_FN_ARG_KEYWORD(arg) \
    >::instance | pkgboost::parameter::aux::use_default_tag()
...
# define BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_ACTUAL_DEFAULT(arg) \
    BOOST_PARAMETER_FUNCTION_CAST( \
        pkgboost::parameter::aux::as_lvalue(BOOST_PARAMETER_FN_ARG_DEFAULT(arg), 0L) \
      , BOOST_PARAMETER_FN_ARG_PRED(arg) \
      , Args \
    )
...
# define BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_DEFAULT_BODY(name, n, split_args, tag_ns, const_) \
    ...
    ResultType BOOST_PARAMETER_FUNCTION_DEFAULT_NAME(name)( \
      ...
      , pkgboost::parameter::aux::use_default_tag \
...
# define BOOST_PARAMETER_FUNCTION_DEFAULT_GET_ARG(r, tag_ns, arg) \
    , BOOST_PARAMETER_FUNCTION_CAST( \
          args[ \
              pkgboost::parameter::keyword<tag_ns::BOOST_PARAMETER_FN_ARG_KEYWORD(arg)>::instance \
          ] \
        , BOOST_PARAMETER_FN_ARG_PRED(arg) \
        , Args \
      )
