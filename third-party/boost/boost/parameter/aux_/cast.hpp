...
struct cast<void(T), Args>
{
    ...
    typedef typename pkgboost::add_reference<
        typename pkgboost::remove_const<type0>::type 
    >::type reference;
...
#  define BOOST_PARAMETER_FUNCTION_CAST(value, predicate, args) \
    pkgboost::parameter::aux::cast<void predicate, args>::remove_const( \
        pkgboost::parameter::aux::cast<void predicate, args>::execute(value) \
    )
