...
namespace pkgboost
{
    ...
    public:
        lock_error()
        : base_type(0, "pkgboost::lock_error")
        {}

        lock_error( int ev )
        : base_type(ev, "pkgboost::lock_error")
        {
        }
    ...
    public:
          ...
          : base_type(system::errc::resource_unavailable_try_again, "pkgboost::thread_resource_error")
          {}

          thread_resource_error( int ev )
          : base_type(ev, "pkgboost::thread_resource_error")
          {
          }
    ...
    public:
          ...
          : base_type(system::errc::invalid_argument, "pkgboost::unsupported_thread_option")
          {}

          unsupported_thread_option( int ev )
          : base_type(ev, "pkgboost::unsupported_thread_option")
          {
          }
    ...
    public:
        ...
        : base_type(system::errc::invalid_argument, "pkgboost::invalid_thread_argument")
        {}

        invalid_thread_argument( int ev )
        : base_type(ev, "pkgboost::invalid_thread_argument")
        {
        }
    ...
    public:
          ...
          : base_type(system::errc::permission_denied, "pkgboost::thread_permission_error")
          {}

          thread_permission_error( int ev )
          : base_type(ev, "pkgboost::thread_permission_error")
          {
          }
