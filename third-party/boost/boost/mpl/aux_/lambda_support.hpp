...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::pkgboost::mpl::aux::yes_tag operator|( \
      ::pkgboost::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::pkgboost::mpl::aux::no_tag operator|( \
      ::pkgboost::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::pkgboost::mpl::na) >* \
    ); \
/**/
...
::pkgboost::mpl::aux::yes_tag operator|( \
      ::pkgboost::mpl::aux::has_rebind_tag<int> \
    , ::pkgboost::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
