...
class atomic :
    public atomics::detail::base_atomic<
        ...
        mpl::and_< pkgboost::is_integral<T>, pkgboost::is_signed<T> >::value
#endif
    >
{
private:
...
typedef atomic<pkgboost::ulong_long_type> atomic_ullong;
typedef atomic<pkgboost::long_long_type> atomic_llong;
#endif
