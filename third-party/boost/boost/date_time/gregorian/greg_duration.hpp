...
namespace gregorian {
  ...
  typedef pkgboost::date_time::duration_traits_adapted date_duration_rep;

  //! Durations in days for gregorian system
  /*! \ingroup date_basics
   */
  class date_duration :
    public pkgboost::date_time::date_duration< date_duration_rep >
  {
    typedef pkgboost::date_time::date_duration< date_duration_rep > base_type;
