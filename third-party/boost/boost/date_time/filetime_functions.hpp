...
namespace winapi {
    ...
    extern "C" {
        ...
        struct FILETIME
        {
            pkgboost::uint32_t dwLowDateTime;
            pkgboost::uint32_t dwHighDateTime;
        };
        struct SYSTEMTIME
        {
            pkgboost::uint16_t wYear;
            pkgboost::uint16_t wMonth;
            pkgboost::uint16_t wDayOfWeek;
            pkgboost::uint16_t wDay;
            pkgboost::uint16_t wHour;
            pkgboost::uint16_t wMinute;
            pkgboost::uint16_t wSecond;
            pkgboost::uint16_t wMilliseconds;
        };
    ...
    inline pkgboost::uint64_t file_time_to_microseconds(FileTimeT const& ft)
    {
