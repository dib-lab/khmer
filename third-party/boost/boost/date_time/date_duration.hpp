...
namespace date_time {
  ...
  class date_duration : private
              pkgboost::less_than_comparable1< date_duration< duration_rep_traits >
            , pkgboost::equality_comparable1< date_duration< duration_rep_traits >
            , pkgboost::addable1< date_duration< duration_rep_traits >
            , pkgboost::subtractable1< date_duration< duration_rep_traits >
            , pkgboost::dividable2< date_duration< duration_rep_traits >, int
            > > > > >
  {
  public:
  ...
  {
    typedef long int_type;
    typedef pkgboost::date_time::int_adapter<long> impl_type;
