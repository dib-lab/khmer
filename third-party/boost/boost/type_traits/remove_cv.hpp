...
{
   typedef typename pkgboost::detail::cv_traits_imp<T*>::unqualified_type type;
};
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(remove_cv,T,typename pkgboost::detail::rvalue_ref_filter_rem_cv<T>::type)
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(remove_cv,T,typename pkgboost::detail::remove_cv_impl<T>::type)
