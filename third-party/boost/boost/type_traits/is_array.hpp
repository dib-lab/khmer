...
{ 
    BOOST_STATIC_CONSTANT(bool, value = 
        sizeof(::pkgboost::detail::is_array_tester2(
            ::pkgboost::detail::is_array_tester1(
                ::pkgboost::type_traits::wrap<T>()
                )
        )) == 1
    );
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_array,T,::pkgboost::detail::is_array_impl<T>::value)
