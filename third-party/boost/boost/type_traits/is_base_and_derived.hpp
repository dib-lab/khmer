...
{
    BOOST_STATIC_CONSTANT(bool, value =
        (::pkgboost::is_convertible<D*,B*>::value));
};
...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<
       ::pkgboost::is_class<B>::value,
       ::pkgboost::is_class<D>::value,
       ::pkgboost::is_same<ncvB,ncvD>::value> selector;
...
struct is_base_and_derived_impl
{
    ...
    BOOST_STATIC_CONSTANT(bool, value = (BOOST_IS_BASE_OF(B,D) && ! ::pkgboost::is_same<ncvB,ncvD>::value));
};
#endif
} // namespace detail
...
BOOST_TT_AUX_BOOL_TRAIT_DEF2(
    ...
    , Base
    , Derived
    , (::pkgboost::detail::is_base_and_derived_impl<Base,Derived>::value)
    )
