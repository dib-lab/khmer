...
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral, ::pkgboost::ulong_long_type,true)
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral, ::pkgboost::long_long_type,true)
...
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral,pkgboost::int128_type,true)
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral,pkgboost::uint128_type,true)
#endif
