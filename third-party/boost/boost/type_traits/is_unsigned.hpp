...
{
   BOOST_STATIC_CONSTANT(bool, value = (::pkgboost::detail::is_unsigned_values<T>::minus_one > ::pkgboost::detail::is_unsigned_values<T>::zero));
};
...
struct is_unsigned_imp
{
   typedef is_ununsigned_select_helper< 
      ::pkgboost::type_traits::ice_or<
         ...
         ::pkgboost::is_enum<T>::value>::value 
   > selector;
...
#else
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_unsigned,T,::pkgboost::detail::is_unsigned_imp<T>::value)
#endif
