...
struct has_trivial_assign_impl
{
   ...
   BOOST_STATIC_CONSTANT(bool, value =
      (::pkgboost::type_traits::ice_and<
        ::pkgboost::is_pod<T>::value,
        ::pkgboost::type_traits::ice_not< ::pkgboost::is_const<T>::value >::value,
      ::pkgboost::type_traits::ice_not< ::pkgboost::is_volatile<T>::value >::value
      >::value));
#endif
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_assign,T,::pkgboost::detail::has_trivial_assign_impl<T>::value)
