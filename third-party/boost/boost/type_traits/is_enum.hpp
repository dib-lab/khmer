...
struct is_class_or_union
{
   BOOST_STATIC_CONSTANT(bool, value =
      (::pkgboost::type_traits::ice_or<
           ::pkgboost::is_class<T>::value
         , ::pkgboost::is_union<T>::value
      >::value));
};
...
# else
    template <class U> static ::pkgboost::type_traits::yes_type is_class_or_union_tester(void(U::*)(void));

#  if BOOST_WORKAROUND(BOOST_MSVC, == 1300)                 \
    || BOOST_WORKAROUND(__MWERKS__, <= 0x3000) // no SFINAE
    static ::pkgboost::type_traits::no_type is_class_or_union_tester(...);
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(is_class_or_union_tester(0)) == sizeof(::pkgboost::type_traits::yes_type));
#  else
    template <class U>
    static ::pkgboost::type_traits::no_type is_class_or_union_tester(...);
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(is_class_or_union_tester<T>(0)) == sizeof(::pkgboost::type_traits::yes_type));
#  endif
# endif
};
#endif
...
{
    template <typename T> struct type
       : public ::pkgboost::is_convertible<typename pkgboost::add_reference<T>::type,::pkgboost::detail::int_convertible>
    {
    };
};
...
{
   //typedef ::pkgboost::add_reference<T> ar_t;
   ...
   BOOST_STATIC_CONSTANT(bool, selector =
      (::pkgboost::type_traits::ice_or<
           ::pkgboost::is_arithmetic<T>::value
         , ::pkgboost::is_reference<T>::value
         , ::pkgboost::is_function<T>::value
   ...
   BOOST_STATIC_CONSTANT(bool, selector =
    ...
    typedef ::pkgboost::detail::is_enum_helper<
          ::pkgboost::detail::is_enum_impl<T>::selector
        > se_t;
#else
    typedef ::pkgboost::detail::is_enum_helper<selector> se_t;
#endif
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_enum,T,::pkgboost::detail::is_enum_impl<T>::value)
