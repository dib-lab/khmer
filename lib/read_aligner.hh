...
static double trans_default[] = { log2(0.9713472), log2(0.0009580), log2(0.0001990), log2(0.0108937), log2(0.0000354), log2(0.0000056),
				log2(0.3760799), log2(0.5497729), log2(0.0108594), log2(0.0255660),
				log2(0.7288489), log2(0.2080714), log2(0.0148817), log2(0.0048314),
				log2(0.7608953), log2(0.0005493), log2(0.0003159), log2(0.2273034), log2(0.0005038), log2(0.0000988),
				log2(0.6820942), log2(0.1205572), log2(0.0721063), log2(0.1245746),
				log2(0.7371161), log2(0.0925331), log2(0.1278756), log2(0.0388125),
}; // from a k=13 training run
enum Nucl {A, C, G, T};
