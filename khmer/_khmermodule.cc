...
static
PyObject *
hash_init_threadsafe(khmer_KCountingHash_Object * me, PyObject * args)
{
    CountingHash * counting = me->counting;

    unsigned int n_table_locks = DEFAULT_TABLE_LOCKS;
    if(!PyArg_ParseTuple(args, "|I", &n_table_locks)) {
        return NULL;
    }
    counting->init_threadstuff(n_table_locks);
...
static
PyObject *
hash_is_threadsafe(khmer_KCountingHash_Object * me, PyObject * args)
{
    CountingHash * counting = me->counting;
    ...
    bool val = counting->is_threadsafe();
...
static
PyObject *
hash_n_table_locks(khmer_KCountingHash_Object * me, PyObject * args)
{
    CountingHash * counting = me->counting;
    if (!PyArg_ParseTuple(args, "")) {
        return NULL;
    ...
    HashIntoType val = counting->n_table_locks();
...
static PyMethodDef khmer_counting_methods[] = {
    ...
    { "n_table_locks", (PyCFunction)hash_n_table_locks, METH_VARARGS, "Number of blocks in the lock array" },
