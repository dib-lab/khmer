...
#
load-into-countgraph.py -x 1e8 -k 20 stamps-reads.ct \
...
../../sandbox/error-correct-pass2.py -C 10 stamps-dn.ct \
	../../data/stamps-reads.fa.gz
load-into-countgraph.py -x 1e8 -k 20 stamps-corr.ct stamps-reads.fa.gz.corr
...
load-into-countgraph.py -x 1e8 -k 20 stamps-part.g0.ct stamps-part.group0000.fa
load-into-countgraph.py -x 1e8 -k 20 stamps-part.g1.ct stamps-part.group0001.fa
