...
from khmer.khmer_args import (build_counting_args, add_loadhash_args,
                              report_on_config, info, add_threading_args)
import argparse
...
def write_pair(record_pair, outfp):
    r1, r2 = record_pair
    write_read(r1, outfp)
    write_read(r2, outfp)
...
def main():  # pylint: disable=too-many-branches,too-many-statements
    ...
    if args.paired:
        handle_record = write_pair
    else:
        handle_record = write_read
    ...
    for index, input_filename in enumerate(args.input_filenames):
        ...
        try:
            ...
            diginorm.start(input_filename, args.cutoff, args.paired, args.threads)
            ...
            total_acc = diginorm.n_processed()
            discarded_acc = diginorm.n_processed()-diginorm.n_kept()
